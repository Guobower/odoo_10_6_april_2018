...
class PartnerLedgerReport(models.AbstractModel):
    ...
    def render_html(self,docids, data=None):
        ...
        if typed == "posted":
            entries = self.env['account.move.line'].search([('move_id.date','>',form),('move_id.date','<',to),('partner_id','=',record_wizard.partner.id),('account_id.name','in',["Account Payable","Account Receivable"]),('move_id.state','=',"posted")])
