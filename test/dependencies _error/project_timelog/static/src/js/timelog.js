$(document).ready(function() {
    ...
    instance.web.WebClient.include({
        show_application: function() {
            ...
            Users.call('has_group', ['project.group_project_user']).done(function(is_employee) {
                if (is_employee){
                    self.timelog_widget  = new TimeLog.TimelogWidget(self);
                    self.timelog_widget.appendTo(self.$el.parents().find('.oe_timelog_placeholder'));
