...
class report_timesheet_task_user(models.Model):
    ...
    timesheet_hrs= fields.Float(string="Timesheet Hours")
    # timesheet_hrs= fields.Float(get_hrs_timesheet, string="Timesheet Hours"),
