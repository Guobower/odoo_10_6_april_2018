...
class hr_create_user_bio_machine(models.Model):
	...
	@api.multi
	def Get_Attenndence_Selenium(self):
		...
		profile.set_preference("browser.download.dir", "/home/odoo")
		chrome_options = Options()
		chrome_options.add_argument("--headless")
		browser = webdriver.Firefox(firefox_profile=profile, firefox_options=chrome_options, executable_path="/home/odoo/geckodriver")
