...
class RegionWiseReport(models.AbstractModel):
	...
	def sales_annexure(self,records):
		...
		workbook = xlsxwriter.Workbook("/home/odoo/odoo-dev/custom_addons/champion/sales_annexure_champion/static/src/customer_invoices.xlsx")
		...
		url = "/home/odoo/odoo-dev/custom_addons/champion/sales_annexure_champion/static/src/customer_invoices.xlsx"
