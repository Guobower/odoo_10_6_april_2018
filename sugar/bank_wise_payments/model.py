...
class PartnerLedgerReport(models.AbstractModel):
    ...
    def render_html(self,docids, data=None):
        ...
        if typed == "all":
            funds = self.env['funds.flow.tree'].search([('date_clearance','>=',form),('date_clearance','<=',to),'|',('party.id','=',partner_wiz.id),('supplier.id','=',partner_wiz.id),('type_transaction','in',["bp","jv"]),('stages','=','clearing')])
