    ...
    def render_html(self,docids, data=None):
        ...
        def getrate(prod):
            ...
            for x in records.tree_link:
                if x.product == prod:
                    if x.appr_rate.name:
                        element = '(' + str(x.appr_rate.name) + ')'
                    if x.appr_rate.partner.name:
                        element = element + ' ' + str(x.appr_rate.partner.name)
                    if x.appr_rate.yarn:
                        element = element + ',' + str(x.appr_rate.yarn.name)
            return element
        ...
        def getworkorders(prod):
            ...
            for x in records.tree_link:
                if x.product == prod:
                    if x.won.order_name not in workorder:
                        if x.won.order_name:
                            workorder.append(x.won.order_name)
